...
const mockOrders: Order[] = [
  {
    ...
    items: [
      { id: "1", name: "Camiseta Básica Algodón", quantity: 2, price: 25.0, image: "/camiseta-basica-algodon.jpg" },
      { id: "2", name: "Jeans Clásicos", quantity: 1, price: 89.9, image: "/jeans-clasicos.jpg" },
    ],
    status: "pending",
    total: 139.9,
    shippingAddress: {
  ...
  },
  {
    ...
    items: [
      { id: "3", name: "Sudadera con Capucha", quantity: 3, price: 45.0, image: "/sudadera-con-capucha.jpg" },
      { id: "5", name: "Chaqueta Denim", quantity: 1, price: 120.0, image: "/camiseta-basica-algodon.jpg" },
    ],
    status: "shipped",
    total: 255.0,
    shippingAddress: {
  ...
  },
  {
    ...
    items: [
      { id: "4", name: "Zapatillas Deportivas", quantity: 1, price: 75.0, image: "/zapatillas-deportivas.jpg" },
      { id: "1", name: "Camiseta Básica Algodón", quantity: 1, price: 25.0, image: "/camiseta-basica-algodon.jpg" },
    ],
    status: "delivered",
    total: 100.0,
    shippingAddress: {
  ...
  },
  {
    ...
    items: [{ id: "2", name: "Jeans Clásicos", quantity: 2, price: 89.9, image: "/jeans-clasicos.jpg" }],
    status: "cancelled",
    total: 179.8,
    shippingAddress: {
  ...
  },
  {
    ...
    items: [
      { id: "3", name: "Sudadera con Capucha", quantity: 2, price: 45.0, image: "/sudadera-con-capucha.jpg" },
      { id: "5", name: "Chaqueta Denim", quantity: 2, price: 120.0, image: "/camiseta-basica-algodon.jpg" },
      { id: "1", name: "Camiseta Básica Algodón", quantity: 1, price: 25.0, image: "/camiseta-basica-algodon.jpg" },
    ],
    status: "processing",
    total: 235.0,
